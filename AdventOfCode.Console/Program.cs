...
switch (puzzleCode)
{
	...
	case "0201":
		...
		Each game is listed with its ID number (like the 11 in Game 11: ...) followed by a semicolon-separated list of subsets of cubes that 
		...
		The first set is 3 blue cubes and 4 red cubes; the second set is 1 red cube, 2 green cubes, and 6 blue cubes; the third set is 
		only 2 green cubes.
		...
		game 3 would have been impossible because at one point the Elf showed you 20 red cubes at once; similarly, game 4 would also have been 
	...
	case "0202":
		...
		As you continue your walk, the Elf poses a second question: in each game you played, what is the fewest number of cubes of 
...
static string? ShowMenu()
{
	...
	Console.WriteLine("To play with a specific puzzle type the related code in the menu below and press Enter...");
	Console.WriteLine(string.Empty);
	Console.WriteLine("0101 - Trebuchet - Part 1");
